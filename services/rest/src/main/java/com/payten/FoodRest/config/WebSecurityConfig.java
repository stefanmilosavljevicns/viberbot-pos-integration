...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/**").permitAll()      // Permitam root path rest-a dok ne setapujem autentikaciju prilikom starta bota IN PROGRESS 
...
//        web.ignoring().antMatchers(HttpMethod.POST, "/auth/login");
        web.ignoring().antMatchers("/api/v1/*", "/api-docs/**", "/swagger-ui/**", "/actuator/**");
