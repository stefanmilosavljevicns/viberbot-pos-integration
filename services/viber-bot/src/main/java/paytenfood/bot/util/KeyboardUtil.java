...
public class KeyboardUtil {
    ...
    public ViberKeyboard setListMenu(String listName) throws JsonProcessingException {
        ...
        for (int i = 0; i < listModels.size(); i++) {
            listMenu.addButton(new ViberButton("IGNORE").setBgColor(whiteColor).setText(String.format("<font color=\"#494E67\"><b>%s</b><br><b>OPIS</b>: %s. <br><b>CENA</b>: %s RSD", listModels.get(i).getName(), listModels.get(i).getDescription(), listModels.get(i).getPrice())).setColumns(4).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.LEFT)).addButton(new ViberButton(String.format("ADD%s", listModels.get(i).getName())).setImage("https://sputnik-it.rs/images/check-mark-final.png").setText("<br><br><br><font color=\"#494E67\"><b>REZERVIŠI</b></font>").setSilent("true").setColumns(2).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.MIDDLE).setTextVAlign(ViberButton.TextAlign.MIDDLE));
        }
        listMenu.addButton(new ViberButton("RETURNTOSTART").setText(String.format("<b><font color=\"#494E67\">%s</b>",RETURN_MENU)).setTextSize(ViberButton.TextSize.LARGE).setBgColor(primarilyColor));
        return listMenu;
    }

    public ViberKeyboard setYesNo(){
        confirmationKeyboard = new ViberKeyboard();
        confirmationKeyboard.addButton(new ViberButton("PAYMENT").setText("<b><font color=\"#494E67\">DA</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor(primarilyColor).setColumns(3).setRows(2));
        confirmationKeyboard.addButton(new ViberButton("CART").setText("<b><font color=\"#494E67\">NE</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor(secondarilyColor).setColumns(3).setRows(2));
        return confirmationKeyboard;
    }

    public ViberKeyboard setPaymentOption(){
        confirmationKeyboard = new ViberKeyboard();
        confirmationKeyboard.addButton(new ViberButton("TIME").setText("<b><font color=\"#494E67\">DA</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor(primarilyColor).setColumns(3).setRows(2));
        confirmationKeyboard.addButton(new ViberButton("TIME").setText("<b><font color=\"#494E67\">NE</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor(secondarilyColor).setColumns(3).setRows(2));
        return confirmationKeyboard;
    }
    ...
    public ViberKeyboard setCartList(String viberId) throws JsonProcessingException {
        ...
        for (int i = 0; i < currentCart.size() - 1; i++) {
            cartList.addButton(new ViberButton("IGNORE").setBgColor(whiteColor).setText(String.format("<b><font color=\"#494E67\">%s</b>", currentCart.get(i))).setColumns(4).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.LEFT)).addButton(new ViberButton(String.format("RMV%s", currentCart.get(i))).setImage("https://sputnik-it.rs/images/remove-mark-final.png").setText("<br><br><font color=\"#494E67\"><b>UKLONI</b></font>").setColumns(2).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setSilent("true").setTextHAlign(ViberButton.TextAlign.MIDDLE).setTextVAlign(ViberButton.TextAlign.MIDDLE));
        }
        cartList.addButton(new ViberButton("IGNORE").setText(String.format("<b><font color=\"#494E67\">%s RSD</b>", currentCart.get(currentCart.size() - 1))).setTextSize(ViberButton.TextSize.LARGE).setBgColor(secondarilyColor).setTextSize(ViberButton.TextSize.LARGE));
        cartList.addButton(new ViberButton("RETURNTOSTART").setText(String.format("<b><font color=\"#494E67\">%s</b>",RETURN_MENU)).setTextSize(ViberButton.TextSize.LARGE).setBgColor(primarilyColor));
        return cartList;
    }
