...
public class KeyboardUtil {
    ...
    public ViberKeyboard setListMenu(String listName) throws JsonProcessingException {
        ...
        for (int i = 0; i < listModels.size(); i++) {
            listMenu.addButton(new ViberButton("0").setText(String.format("<br><b>%s</b><br>OPIS: %s. <br>CENA: %s", listModels.get(i).getName(), listModels.get(i).getDescription(), listModels.get(i).getPrice())).setColumns(4).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.LEFT)).addButton(new ViberButton(String.format("ADD%s", listModels.get(i).getName())).setImage("https://sputnik-it.rs/images/check-mark-final.png").setText("<br><br><br><font color=\"#494E67\"><b>REZERVIŠI</b></font>").setColumns(2).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.MIDDLE).setTextVAlign(ViberButton.TextAlign.MIDDLE));
        }
        listMenu.addButton(new ViberButton("0").setText("<b>POVRATAK NA GLAVNI MENI</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor("#7eceea"));
        return listMenu;
    }
    ...
    public ViberKeyboard setCartList(String viberId) throws JsonProcessingException {
        ...
        for (int i = 0; i < currentCart.size() - 1; i++) {
            cartList.addButton(new ViberButton("0").setText(String.format("<b>%s</b>", currentCart.get(i))).setColumns(4).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.MIDDLE)).addButton(new ViberButton(String.format("RMV%s", currentCart.get(i))).setImage("https://sputnik-it.rs/images/check-mark-final.png").setText("<br><br><font color=\"#494E67\"><b>UKLONI</b></font>").setColumns(2).setRows(2).setTextSize(ViberButton.TextSize.MEDIUM).setTextHAlign(ViberButton.TextAlign.MIDDLE).setTextVAlign(ViberButton.TextAlign.MIDDLE));
        }
        cartList.addButton(new ViberButton("0").setText(String.format("<b>%s</b>", currentCart.get(currentCart.size() - 1))).setTextSize(ViberButton.TextSize.LARGE).setBgColor("#a8aaba").setTextSize(ViberButton.TextSize.LARGE));
        cartList.addButton(new ViberButton("0").setText("<b>POVRATAK NA GLAVNI MENI</b>").setTextSize(ViberButton.TextSize.LARGE).setBgColor("#7eceea"));
        return cartList;
    }
    ...
    public void setMainMenu() {
        ...
        mainMenu.addButton(new ViberButton("1").setText("<br><font color=\"#494E67\"><b>Zavrsi rezervaciju</b></font>").setImage("https://sputnik-it.rs/images/Zavrsi rezervaciju.png").setRows(2).setColumns(2).setBgColor("#a8aaba").setTextSize(ViberButton.TextSize.LARGE).setTextHAlign(ViberButton.TextAlign.MIDDLE).setTextVAlign(ViberButton.TextAlign.MIDDLE));
